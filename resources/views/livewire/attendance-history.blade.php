                ...
                @foreach ($employees as $employee)
                    <tr wire:key="{{ $employee->id }}" class="group">
                        ...
                        @if ($showUserDetail)
                            ...
                            @if (!$isPerDayFilter)
                                <td
                                    ...
                                    @if ($isPresent)
                                        <span
                                            class="px-2 py-1 rounded bg-green-200 dark:bg-green-800 text-green-800 dark:text-green-200">
                                            Hadir
                                        </span>
                                    @else
                                        <span
                        ...
                        @foreach ($dates as $date)
                            ...
                            @endphp
                            <td class="{{ $bgColor }} text-nowrap cursor-pointer px-1 py-3 text-center text-sm font-medium text-gray-900 dark:text-white"
                        ...
                        @if ($isPerDayFilter)
                            ...
                            <td
                                ...
                                @if ($attendance)
                                    <button wire:click="showAttendanceDetail({{ $attendance->id }})"
