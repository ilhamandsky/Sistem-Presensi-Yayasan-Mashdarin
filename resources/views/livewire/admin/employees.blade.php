    ...
    <div class="overflow-x-scroll">
        <table class="w-full overflow-hidden rounded-t-lg">
            <thead style="background-color:rgb(176, 201, 251);">
                <tr>
                    <th scope="col"
                        class="px-2 py-2 text-center text-xs font-medium text-black-500 dark:text-gray-300">
                        No.
                    </th>
                    <th scope="col"
                        class="px-6 py-3 text-left text-xs font-medium text-black-500 dark:text-gray-300">
                        {{ __('Nama') }}
                    </th>
                    <th scope="col"
                        class="px-6 py-3 text-left text-xs font-medium text-black-500 dark:text-gray-300">
                    ...
                    <th scope="col"
                        class="px-6 py-3 text-left text-xs font-medium text-black-500 dark:text-gray-300 width-20 text-center">
                        {{ __('Actions') }}
                    </th>
                </tr>
            </thead>
            <tbody class="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-800">
                @foreach ($users as $user)
                    <tr wire:key="{{ $user->id }}" class="group">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-900 dark:text-white cursor-pointer"
                        ...
                        <td class="px-6 py-2 whitespace-nowrap text-sm font-medium">
                            <div class="flex justify-center space-x-2">
                                <x-edit-button wire:click="edit('{{ $user->id }}')">
                                    Edit
                                </x-edit-button>
                                <x-delete-button
